...
const adminActions = {
      async getProducts({ commit }) {
        ...
        async getBlacklist({ commit }) {
            try {
                const res = await axiosClient.get("/blacklist");
                return res.data;
            } catch (err) {
                return err;
            }
      ...
      async  getStockStatistics(){
        ...
        async getLastOrders() {
            try {
                const response = await axiosClient.get("/last-orders");
                return response.data;
            } catch (error) {
                return error;
            }
        ...
        async destroyBlacklist({ commit }, user_id) {
            try {
                const response = await axiosClient.delete(
                    `/blacklist/${user_id}`
                );
       ...
       async addToBlacklist({ commit }, { user_id, reason }) {
            return await axiosClient
        ...
        async destroyImage({ commit },  {image_id}) {
            try {
                const response = await axiosClient.delete("/more-images/"+image_id);
                return response;
            } catch (error) {
                return error;
            }
        },
        async fetchAllImages({ commit },  product_id) {
            try {
                const response = await axiosClient.get("/more-images", {
                    params: { product_id }, // This will be appended to the URL as a query parameter
                });
                return response;
            } catch (error) {
                return error;
       ...
       async setAsAdmin({ commit }, user_id) {
        ...
        async setOrderStatus({ commit }, { status, id }) {
            try {
                const response = await axiosClient.post(`/order-status`, {
                    status,
                    id,
                });
                return response;
