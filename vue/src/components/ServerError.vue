    ...
    <div class="w-full h-screen flex flex-col items-center justify-center">
        ...
        <div class="w-full h-screen xl:-mt-[13rem] -mt-[15rem] md:-mt-[25rem] flex flex-col items-center justify-center">
            ...
            <div class="flex flex-col items-center justify-center">
                <p class="text-5xl md:text-6xl lg:text-7xl font-bold tracking-wider text-red-600 mt-8">500</p>
        ...
        <a href="#"
            ...
            <router-link :to="{ name: user.is_admin ? 'dashboard' : 'login' }">Return Home</router-link> </a>
    </div>
</template>
