...
<template>
  ...
  <div>
          ...
          <div class="flex items-center justify-start">
            ...
            <a href="#" class="text-xl font-bold flex items-center lg:ml-2.5">
              <img
                ...
                alt="Olive Logo"
              />
              <span id="brand" class="self-center whitespace-nowrap"
                >OilStore</span
              >
            </a>
          </div>
    ...
    <div class="flex overflow-hidden bg-white pt-16">
      ...
      >
        <div
          class="relative flex-1 flex shadow-md h-full flex-col min-h-0 border-r border-gray-200 pt-0"
        >
            ...
            <div class="flex-1 px-3  bg-white divide-y space-y-1">
              <ul class="space-y-2 pb-2">
                <li>
                  <router-link
                    :to="{ name: 'dashboard' }"
                    class="text-base mt-3 text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group"
                  >
      ...
      <div
        id="main-content"
        class="h-full w-full bg-gray-50 relative overflow-y-auto overflow-x-hidden lg:ml-64"
      >
        <main>
