      ...
      >
        ...
        >
          <template #body="{ data }">
            <img
              v-if="data.image"
              class="w-36 h-24 rounded-sm"
              :src="data.image"
              alt="Product Image"
            />
            <span v-else>No Image fot this product</span>
          </template>
        </Column>
        <Column
          field="description"
        ...
        <Column header="Actions" class="text-center">
          <template #body="{ data }">
            <div class="flex gap-3">
              <button
                title="Add more images to this product"
                @click="
                  visible2 = true;
                  productId = data.id;
                "
        ...
        <div class="flex items-center justify-center w-full">
          ...
          >
            <div class="flex flex-col items-center justify-center pt-5 pb-6">
              <svg
                class="w-8 h-8 mb-4 text-gray-500 white:text-gray-400"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 20 16"
    ...
    >
      <form class="max-w-md mx-auto mt-4 w-full">
        <div class="relative z-0 w-full mb-5 group">
          ...
          <label
            for="product_name"
            class="peer-focus:font-medium absolute text-lg text-gray-500 duration-300 transform -translate-y-6 scale-75 top-2 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:white:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
            >Nom Produit</label
          >
        </div>
        <div class="relative z-0 w-full mb-5 group">
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
          <div class="relative z-0 w-full mb-5 group">
            ...
            <label
              for="product_price"
              class="peer-focus:font-medium absolute text-lg text-gray-500 duration-300 transform -translate-y-6 scale-75 top-2 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:white:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
              >Prix</label
            >
          </div>
          <div class="relative z-0 w-full mb-5 group">
