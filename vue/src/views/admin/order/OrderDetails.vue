  ...
  <div class="card mt-2 m-3 bg-gray-50  rounded-xl">
    ...
    >
      <div class="flex justify-start item-start space-y-2 flex-col">
        <h1
          class="text-3xl white:text-white lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-800"
        >
          Order #{{ order.id }}
        </h1>
        <p
          class="text-base white:text-gray-300 font-medium leading-6 text-gray-600"
        >
              ...
              >
                ...
                <tbody v-if="order.items.length">
                  <tr
                    ...
                    :key="item.id"
                    class="overflow-y-scroll bg-white border-b white:bg-gray-800 white:border-gray-700 hover:bg-gray-50 white:hover:bg-gray-600"
                  >
                    <td class="p-4">
                      <img
                    ...
                    <td
                      class="px-6 py-4 font-semibold text-gray-900 white:text-white"
                    >
                      {{ item.product.product_name }}
                    </td>
                    <td class="px-6 py-4">
                      <span
                        class="font-medium text-black white:text-red-500 hover:underline"
                        >{{ item.quantity }}</span
                      >
                    </td>
                    <td
            ...
            >
              ...
              >
                <div class="flex justify-between w-full">
                  ...
                  <p
                    class="text-base white:text-gray-300 leading-4 text-gray-600"
                  >
                ...
                <div class="flex justify-between items-center w-full">
                  <p class="text-base white:text-white leading-4 text-gray-800">
                    Discount
                    <span
                      class="bg-gray-200 p-1 text-xs font-medium white:bg-white white:text-gray-800 leading-3 text-gray-800"
                      >STUDENT</span
                    >
                  </p>
                  <p
              ...
              <div class="flex justify-between items-center w-full">
                <p
                  class="text-base white:text-white font-semibold leading-4 text-gray-800"
                >
                  Total
                </p>
                <p
                  class="text-base white:text-gray-300 font-semibold leading-4 text-gray-600"
                >
                  {{ common.formatNumber(order.payment.amount) }}
                  MAD
                </p>
              ...
              <div class="flex justify-between items-start w-full">
                <div class="flex justify-center items-center space-x-4">
                  ...
                  <div class="flex flex-col justify-start items-center">
                    <p
                      class="text-lg leading-6 white:text-white font-semibold text-gray-800"
                    >
                ...
                <p
                  class="text-lg font-semibold leading-6 white:text-white text-gray-800"
                >
                  $8.00
                </p>
              </div>
        ...
        >
          ...
          >
            <div class="flex flex-col justify-start items-start flex-shrink-0">
              ...
              >
                ...
                <div class="flex justify-start items-start flex-col space-y-2">
                  ...
                  <p
                    class="text-sm white:text-gray-300 leading-5 text-gray-600"
                  >
            ...
            >
              ...
              >
                <button
                  class="mt-6 md:mt-0 white:border-white white:hover:bg-gray-900 white:bg-transparent white:text-white py-5 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 border border-gray-800 font-medium w-96 2xl:w-full text-base font-medium leading-4 text-gray-800"
                >
                  Edit Details
                </button>
              </div>
    ...
    <div v-else class="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
      ...
      <div
        class="flex justify-start bg-white item-start p-4 space-y-2 flex-col"
      >
      ...
      >
        ...
        >
          <div
            class="flex flex-col gap-3 justify-center items-center white:bg-gray-800 bg-gray-50 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full"
          >
            <p
            ...
            <div class="">
              <Skeleton width="42rem" height="16rem"></Skeleton>
            </div>
          </div>
          <div
            ...
            >
              ...
              <div class="flex justify-between items-start w-full">
                <div class="flex justify-center items-center space-x-4">
                  ...
                  <div class="flex flex-col justify-start items-center">
                    <Skeleton width="18rem" class="mb-3"></Skeleton>
                    <Skeleton width="18rem"></Skeleton>
                  </div>
                </div>
