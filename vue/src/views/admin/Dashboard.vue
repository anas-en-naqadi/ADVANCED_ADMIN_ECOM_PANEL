      ...
      <div class="mb-813 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
        ...
        >
          ...
          <div class="border-t border-blue-gray-50 p-4">
            <p
              v-if="statistics.moneyChange >= 0"
              class="flex items-center antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600"
            >
              <strong v-if="statistics.moneyChange" class="text-green-500"
                >+{{ statistics.moneyChange }}%</strong
              ><strong v-else class="text-green-500 mr-1.5"
                ><Skeleton width="3rem"></Skeleton></strong
              >
              &nbsp;than last week
            </p>
            <p
              ...
              class="flex items-center antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600"
            >
               <strong v-if="statistics.moneyChange" class="text-red-500"
                >+{{ statistics.moneyChange }}%</strong
        ...
        >
          ...
          <div class="border-t border-blue-gray-50 p-4">
            <p
              v-if="statistics.usersChange >= 0"
              class="flex items-center  antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600"
            >
              <strong v-if="statistics.usersChange" class="text-green-500"
                >+{{ statistics.usersChange }}%</strong
              >
              <strong v-else class="text-green-500 mr-1.5"
                ><Skeleton width="3rem"></Skeleton></strong
              >
            ...
            <p
              ...
              class="flex items-center antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600"
            >
             <strong v-if="statistics.usersChange" class="text-red-500"
                >+{{ statistics.usersChange }}%</strong
              >
              <strong v-else class="text-red-500 mr-1.5"
                ><Skeleton width="3rem"></Skeleton></strong
        ...
        >
          ...
          <div class="border-t border-blue-gray-50 p-4">
            <p
              v-if="statistics.newClientsChange >= 0"
              class="flex items-center antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600"
            >
        ...
        >
          ...
          <div class="p-4 text-right">
            ...
            <h4
            v-if="statistics.todaysSalesAmount >= 0"
              class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900"
            >
              {{
          ...
          <div class="border-t border-blue-gray-50 p-4">
            ...
            <p
v-if="statistics.salesAmountChange >= 0"
              class="flex items-center antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600"
            >
    ...
    <div class="pt-6 px-4">
      <div class="w-full grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-4 gap-4">
        ...
        <div
          class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 2xl:col-span-4"
        >
            ...
            <div class="overflow-x-auto rounded-lg">
              <div class="align-middle inline-block min-w-full">
                <div class="shadow overflow-hidden sm:rounded-lg">
                  <Bar
                    v-if="monthlySales.labels && monthlySales.data"
                    id="my-chart-id"
                    :data="{
                    ...
                    class="w-[60rem]"
                  />
                  <Skeleton v-else height="25rem" width="63rem"></Skeleton>
                </div>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div v-else>
            ...
            <div class="flex flex-col mt-2 items-center justify-center">
              ...
              <Skeleton width="23rem" shape="circle" height="23rem"></Skeleton>
            </div>
          </div>
        </div>
        <div
          class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8 2xl:col-span-2"
        >
          <div v-if="weeklySales.labels && weeklySales.data">
            <div class="flex items-center justify-between mb-4">
              <div class="flex-shrink-0">
                <span
                  class="text-2xl sm:text-3xl leading-none font-bold text-gray-900"
                  >{{ statistics.thisWeekSalesAmount }} DH</span
                >
              ...
              <div
                v-if="statistics.salesWeekChange >= 0"
              ...
              <div
                v-else
                class="flex items-center justify-end flex-1 text-red-500 text-base font-bold"
              >
                {{ statistics.salesWeekChange }}%
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div v-else>
            ...
            <Skeleton width="46rem" height="30rem"></Skeleton>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="bg-white shadow rounded-lg mb-4 p-4 sm:p-6 h-full">
        <div v-if="users.length >= 0" class="mb-4 flex items-center justify-between">
          <div>
            ...
            <span class="text-base font-normal text-gray-500"
              >This is a list of latest Customers</span
            >
          </div>
        ...
        <div class="flow-root">
          <ul v-if="users.length >=0 ">
            ...
            <div v-else class="text-center w-full text-sm text-red-600 py-4">No new customers have placed orders recently.</div>
          </ul>
          <ul v-else>
      ...
      <div class="bg-white shadow rounded-lg p-4 sm:p-6 xl:p-8">
        <div class="mb-4 flex items-center justify-between">
          <div>
            ...
            <span class="text-base font-normal text-gray-500"
              >This is a list of latest Orders</span
            >
          </div>
          <div class="flex-shrink-0">
            <a
...
<tr v-for="order in orders" :key="order.id">
                      ...
                      >
                        <span
                          class="rounded-md p-1.5 text-gray-200 text-xs"
                          :class="[
 ...
 <tr v-if="orders.length === 0">
                        <td colspan="3" class="py-3 text-red-600 text-sm">No orders have been placed yet.</td>
                    </tr>
...
const pieChartData = ref({
  labels: ["Canceled", "returned", "confirmed"],
  datasets: [
    {
