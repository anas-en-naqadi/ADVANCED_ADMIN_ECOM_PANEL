...
<template>
  ...
  >
    <div class="sm:mx-auto sm:w-full sm:max-w-sm sm:max-h-sm -mt-12">
      ...
      />
      <h2
        class="mt-5 text-center text-xl font-bold leading-9 tracking-tight text-green-900"
      >
    ...
    <div class="mt-7 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6">
        <div v-if="errorMsg.length || message" class="flex p-4  mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
  ...
  <div>
    ...
    <ul v-if="message" class="mt-1.5 list-disc list-inside">
        ...
        <div>
          ...
          <div class="mt-2">
            <input
              ...
              autocomplete="email"
              required
              placeholder="oil_store@example.com"
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <a
              ...
              class="font-semibold text-green-600 hover:text-green-500 hover:underline"
              >Forgot Password?</a
            >
          </div>
        </div>
      ...
      <p class="mt-6 text-sm text-gray-400 text-center">or continue with</p>
      <div class="space-x-6 mt-4 flex justify-center">
        <button type="button" @click="google" class="border-none outline-none">
          <svg
        ...
        <button type="button" @click="facebook" class="border-none outline-none">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="30px"
            fill="#007bff"
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        ...
        <a
          href="/register"
          class="font-semibold leading-6 text-green-600 hover:text-green-500 hover:underline"
          >Register</a
        >
      </p>
    </div>
    ...
    .then((res) => {
      ...
      if (res.status === 200) {
        setTimeout(() => {
          ...
          else window.location.href = "http://localhost:5173/admin/dashboard";
        }, 1300);
