<template>
  <div class="min-h-screen flex items-center w-full justify-center"
    ...
    <div class="flex flex-row gap-10 xl:w-[45%] w-[70%] xl:flex-nowrap flex-wrap justify-center items-center p-6 border shadow-lg rounded-lg bg-white">
      <div class="flex flex-col items-center mb-6">
        <img class="h-22 w-22 mb-2" src="@/assets/images/olive.png" alt="Your Company" />
      ...
      <form class="w-full">
        <div class="mt-8">
          ...
          <div id="success" class="flex hidden p-4 mt-2 -mb-2 text-sm text-green-600 rounded-lg bg-green-50" role="alert">
          ...
          <div class="mt-2">
            <input v-model="email" id="email" name="email" type="email" autofocus autocomplete="email" required=""
        ...
        <div class="mt-4">
          <Button :loading="loading" @trigger-event="sendVerificationCode()" :string="'Verify Now'" :color="'green'" />
        </div>
      </form>
    </div>
  </div>
